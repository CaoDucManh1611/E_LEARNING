...
import com.example.doan.Repository.InvoiceRepository;
...
/**
 * Service quản lý hóa đơn (Invoice). Tự động tạo hóa đơn khi thanh toán thành công.
 * File: Service/Invoice_Service.java
 */
@Service
