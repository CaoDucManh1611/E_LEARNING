...
/**
 * Thực thể Course ánh xạ tới bảng 'courses' trong MySQL.
 * Tuân thủ phong cách code thủ công của E_LEARNING-main.
...
public class Course {
    ...
    public Course(Long id, Category category, User teacher, String tenKhoaHoc, String moTa, BigDecimal gia, String capDo, String hinhAnh, String trangThai, LocalDateTime createdAt) {
        this.id = id;
