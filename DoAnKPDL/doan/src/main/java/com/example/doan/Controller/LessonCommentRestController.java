...
import com.example.doan.Service.LessonComment_Service;
...
/**
 * REST Controller cung cấp các API AJAX để tải động bình luận & hỏi đáp của bài học trực tiếp ở giao diện Classroom.
 * File: Controller/LessonCommentRestController.java
 */
@RestController
