...
/**
 * Controller xử lý các yêu cầu hoàn tiền và xem đơn hàng của học sinh.
 * File: Controller/StudentRefundController.java
 */
@Controller
...
public class StudentRefundController {
    ...
    private final com.example.doan.Service.Invoice_Service invoiceService;
    ...
    public StudentRefundController(OrderRepository orderRepo,
                                   ...
                                   com.example.doan.Service.Invoice_Service invoiceService) {
    ...
    public String viewInvoice(@PathVariable("orderId") Long orderId, Model model) {
        ...
        com.example.doan.Model.Invoice invoice = invoiceService.Get_Invoice_By_Order(orderId)
