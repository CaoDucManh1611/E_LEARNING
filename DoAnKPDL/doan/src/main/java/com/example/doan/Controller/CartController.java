...
/**
 * Controller điều phối các hoạt động của Giỏ hàng (Cart) và áp dụng mã giảm giá.
...
public class CartController {
    ...
    public String addToCart(@PathVariable("courseId") Long courseId, HttpSession session) {
